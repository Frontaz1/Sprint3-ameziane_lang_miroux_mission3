...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 18 mars 2022 à 11:01
...
INSERT INTO `biens` (`ref`, `descrip`, `prix`, `surface`, `type`, `ville`, `nbPiece`) VALUES
...
(29, 'Grand local commercial de 196 m2 en rez-de-chaussée dont 100 mètres sur rue. Ancienne agence bancaire, convient parfaitement pour secteur tertiaire (banque, assurance, services, profession libérale..). Accès handicapé et issue de secours. Excellent emplacement à proximité de la place du Tourcoing et du tour de ville, stationnement aisé et gratuit, exposé plein sud, à proximité de tous les commerces. Idéal pour commerces bijouterie, d\'informatique, téléphonie, internet, courtier d\'assurance, architecte, expertise comptable, centre de formation professionnelle', 250000, 196, 4, 'Arras', NULL),
(30, 'LOCAL COMMERCIAL 48m2 / VERSAILLES RIVE DROITE ULJO vous propose à la vente un local commercial entièrement rénové d\'une surface de 48m2 situé quartier rive droite à Versailles. Il comprend une grande cave permettant du stockage.', 120000, 50, 4, 'Versaille', NULL),
